...
%\linenumbers
	...
	\textbf{\LARGE \textcolor{red}{DRAFT 2-16-26}}
...
\end{figure}
	...
	\Session{Room B}{Adaptive Social Networks and Belief Dynamics (80 min 
	session)}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		\Talk{3:45}{Why We Experience Society Differently: Intrinsic Dispositions as 
	...
	\Session{Room B}{LLM Agents in Social Systems}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
