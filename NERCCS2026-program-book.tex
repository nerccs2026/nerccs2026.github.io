...
\newcommand{\OverviewGrid}{%
	\section*{At-a-Glance Schedule}

	\subsection*{Day 1 --- Wednesday, March 11}
	\begin{tabularx}{\textwidth}{>{\bfseries}p{2.7cm} Y Y}
		\hline
		Time & Sloan Auditorium (Goergen 101) & Fantone Lecture Hall (Goergen 109) \\
		\hline
		12:00 & \multicolumn{2}{l}{\textit{Registration (12:00--4:00) \& Coffee (Munnerlyn Atrium)}} \\
		1:00--1:30 & \multicolumn{2}{l}{\textit{Opening Remarks}} \\
		1:30--2:30 & \multicolumn{2}{l}{\textit{Keynote: Juan Perez-Mercader (Harvard University)}} \\
		2:30--2:45 & \multicolumn{2}{l}{\textit{Break}} \\
		2:45--3:45 & Network Control, Measurement, and Bias & Adaptive Social Networks and Belief Dynamics \\
		3:45--4:00 & \multicolumn{2}{l}{\textit{Break}} \\
		4:00--5:00 & Information, Entropy, and Behavioral Signals & Media, Platforms, and Field Mapping \\
		\hline
	\end{tabularx}
	\vspace{0.8em}

	\subsection*{Day 2 --- Thursday, March 12}
	\begin{tabularx}{\textwidth}{>{\bfseries}p{2.7cm} Y Y}
		\hline
		Time & Sloan Auditorium (Goergen 101) & Fantone Lecture Hall (Goergen 109) \\
		\hline
		8:00 & \multicolumn{2}{l}{\textit{Continental Breakfast (Munnerlyn Atrium)}} \\
		9:15--10:15 & \multicolumn{2}{l}{\textit{Keynote: Filippo Radicchi (Indiana University)}} \\
		10:15--10:30 & \multicolumn{2}{l}{\textit{Break}} \\
		10:30--11:30 & Social / Institutional Simulation and Innovation Dynamics & Infrastructure, Risk, and Public/Health Networks \\
		11:30--1:30 & \multicolumn{2}{l}{\textit{Buffet Lunch (Munnerlyn Atrium)}} \\
		1:30--2:30 & Graph Methods and Applied Dynamics & Computational Models and Algorithm Diagnostics \\
		2:30--2:45 & \multicolumn{2}{l}{\textit{Coffee Break (Munnerlyn Atrium)}} \\
		2:45--3:45 & \multicolumn{2}{l}{\textit{Keynote: Adilson Motter (Northwestern University)}} \\
		3:45--4:00 & \multicolumn{2}{l}{\textit{Break}} \\
		4:00--5:00 & Self-Organization, Robustness, and Epidemic Coupling & Collapse, Inequality, and Sustainability Dynamics \\
		\hline
	\end{tabularx}
	\vspace{0.8em}

	\subsection*{Day 3 --- Friday, March 13}
	\begin{tabularx}{\textwidth}{>{\bfseries}p{2.7cm} Y Y}
		\hline
		Time & Sloan Auditorium (Goergen 101) & Fantone Lecture Hall (Goergen 109) \\
		\hline
		8:00 & \multicolumn{2}{l}{\textit{Continental Breakfast (Munnerlyn Atrium)}} \\
		9:00--9:15 & \multicolumn{2}{l}{ Announcements (Sloan Auditorium)}\\
		9:15--10:15 & \multicolumn{2}{l}{\textit{Keynote: Krishnan Padmanabhan (University of Rochester)}} \\
		10:30--11:30 & LLM Learning, Optimization, and Alignment & LLM Agents in Social Systems \\
		\hline
	\end{tabularx}
	\vspace{1.0em}
}
...
\end{figure}
	...
	\BreakItem{Coffee | Munnerlyn Atrium}{12:00 }

	% ===== Block 1 =====
	\TimeBlock{Opening Remarks}{1:00 - 1:30}{Sloan Auditorium (Goergen 101)}
	\TimeBlock{Keynote}{1:30-2:30}{Sloan Auditorium}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{}{Life Exists Beyond Biochemistry: Making Abiotic (Biochemistry-free) Life in
			the Computer and the Test-tube}{Juan Perez-Mercader}{Harvard University}{}
	\end{itemize}
	...
	\Session{Sloan Auditorium (Goergen 101)}{Network Control, Measurement, and 
	Bias}{Sadamori Kojaku (Binghamton University)}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Adaptive Social Networks and Belief 
	Dynamics}{Damian Sowinski (University of Rochester)}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		Gangadhar}{Binghamton University, SUNY}{}
	...
	\Session{Sloan Auditorium (Goergen 101)}{Information, Entropy, and Behavioral 
	Signals}{Georgi Yordanov Georgiev (Assumption University \& Worcester 
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Media, Platforms, and Field 
	Mapping}{Damian Sowinski (University of Rochester)}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{4:00}{How News Connects:  Mapping the Semantic Topology of a Digital 
		Newspaper}{Sofia Sciangula}{Carlo Cattaneo University LIUC}{Remote}
	...
	\BreakItem{Continental Breakfast |  Munnerlyn Atrium}{8:00}

	% ===== Block 3 =====

	\TimeBlock{Keynote}{9:15-10:15}{Sloan Auditorium}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{}{Optimal Networks in Urban Transport Systems
	...
	\Session{Sloan Auditorium (Goergen 101)}{Social / Institutional Simulation and 
	Innovation Dynamics}{Hiroki Sayama (Binghamton University)}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{10:30}{A Simulation Model for Historical Evolution of Geopolitical 
		Entities}{Andrea Agosta}{Carlo Cattaneo University LIUC}{Remote}
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Infrastructure, Risk, and 
	Public/Health Networks}{Damian Sowinski (University of Rochester)}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		Detection in Epilepsy Social Media}{Ziqi Guo}{Binghamton University, SUNY}{Remote}
	\end{itemize}
	
	\TimeBlock{Buffet Lunch}{11:30 - 1:30}{Munnerlyn Atrium}
	
	\TimeBlock{Parallel Sessions 4}{1:30 - 2:30}{}
	
	\Session{Sloan Auditorium (Goergen 101)}{Graph Methods and Applied 
	Dynamics}{Georgi Yordanov Georgiev (Assumption University \& Worcester 
	Polytechnic Institute)}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Computational Models and Algorithm 
	Diagnostics}{Hiroki Sayama (Binghamton University)}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\vspace{1em}
	\BreakItem{Coffee Break | Munnerlyn Atrium}{2:30 - 2:45 }
	\TimeBlock{Keynote}{2:45 - 3:45}{Sloan Auditorium}
		\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{}{Putting Time First: How Dynamics Encode Higher-Order Structure}{Adilson Motter}{Northwestern University}{}
	\end{itemize}
	...
	\Session{Sloan Auditorium (Goergen 101)}{Self-Organization, Robustness, and 
	Epidemic Coupling}{Sadamori Kojaku (Binghamton University)}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		\Talk{4:40}{A symbiotic SIR process}{Gerardo Palafox-Castillo}{Universidad Autonoma de Nuevo Leon}{Remote}
	\end{itemize}
	
	\Session{Fantone Lecture Hall (Goergen 109)}{Collapse, Inequality, and 
	Sustainability Dynamics}{Sean Maley (Finger Lakes CC \& Binghamton University)}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{4:00}{A Meta-Model of Endogenous Overcrowding-Driven Demographic 
		Collapse}{Federico Carucci}{Carlo Cattaneo University LIUC}{Remote}
		\Talk{4:20}{Parasites become rich and drive inequality in approach to 
		collapse in a model of evolving networks}{Atiyab Zafar}{University of 
		Delhi}{Remote}
		\Talk{4:40}{Artificial Agents and Ecological Collapse: an LLM-enhanced 
		Agent-Based Model of a Sustainability Game}{Francesco Bertolotti}{Carlo Cattaneo University LIUC	}{Remote}
	\end{itemize}
	...
	\TimeBlock{Announcements \& Remarks}{9:00 - 9:15}{}
	\TimeBlock{Keynote}{9:15 - 10:15}{Sloan Auditorium}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{}{Complexity Across Scales of Space and time in the Brain}{Krishnan Padmanabhan }{University of Rochester}{}
	\end{itemize}
	
	\TimeBlock{Parallel Sessions 6}{10:30 - 11:30}{}
	
	\Session{Sloan Auditorium (Goergen 101)}{LLM Learning, Optimization, and 
	Alignment}{Georgi Yordanov Georgiev (Assumption University \& Worcester 
	Polytechnic Institute)}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		Competitive Market Simulations}{Ossama Zaroual}{Carlo Cattaneo University LIUC}{Remote}
		\Talk{11:10}{Cooperation or Defection? The Decay of Alignment Instructions in 
		Complex LLM Systems}{Andrea Monoli}{Carlo Cattaneo University LIUC}{Remote}
	\end{itemize}
	
	\Session{Fantone Lecture Hall (Goergen 109)}{LLM Agents in Social 
	Systems}{Andreas Duus Pape (Binghamton University)}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{10:30}{Large Language Model Agents Partially Reproduce Real-World 
		Segregation Patterns in the Schelling Model}{Andreas Duus Pape}{Binghamton 
		University, SUNY}{}
		\Talk{10:50}{Going for the Third: Cooperation between LLM Agents in a 
		Three-Option Setting}{Leonardo Mascagni}{Carlo Cattaneo University 
		LIUC}{Remote}
...
\subsubsection*{Thank you to our Official Sponsors:}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{jointFullLogo}
