...
\end{figure}
	...
	\Session{Sloan Auditorium (Goergen 101)}{Network Control, Measurement, and Bias}{Sadamori Kojaku, Binghamton University}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Adaptive Social Networks and Belief Dynamics}{Hiroki Sayama, Binghamton University}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Sloan Auditorium (Goergen 101)}{Information, Entropy, and Behavioral Signals}{Georgi Yordanov Georgiev, Assumption University \& Worcester Polytechnic Institute}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Media, Platforms, and Field Mapping}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Sloan Auditorium (Goergen 101)}{Social / Institutional Simulation and Innovation Dynamics}{Hiroki Sayama, Binghamton University}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Infrastructure, Risk, and Public/Health Networks}{Damian Sowinski, University of Rochester}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Sloan Auditorium (Goergen 101)}{Graph Methods and Applied Dynamics}{Georgi Yordanov Georgiev, Assumption University \& Worcester Polytechnic Institute}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{Computational Models and Algorithm Diagnostics}{Damian Sowinski, University of Rochester}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Sloan Auditorium (Goergen 101)}{LLM Learning, Optimization, and Alignment}{Georgi Yordanov Georgiev, Assumption University \& Worcester Polytechnic Institute}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Fantone Lecture Hall (Goergen 109)}{LLM Agents in Social Systems}{Andreas Duus Pape, Binghamton University}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		Three-Option Setting}{Leonardo Mascagni}{Carlo Cattaneo University LIUC}{Remote}
		\Talk{11:10}{\sout{An Extension of the Sugarscape Model with LLM-based 
		Agents}}{\sout{Luca Moroni}}{\sout{Carlo Cattaneo University LIUC}}{}
