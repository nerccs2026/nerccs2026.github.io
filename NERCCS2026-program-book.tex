...
%\linenumbers
	...
	{\NERCCS}
	{Program Booklet}
	{Location: \textit{University of Rochester, Rochester, NY, Venue TBD}\quad 
	$\cdot$\quad Dates: 
	\textit{March 11--13, 2026}}
	
	
	\begin{center}
		
	\textbf{\LARGE \textcolor{red}{DRAFT 2-3-26}}
...
\end{figure}
	...
	\Session{Room A}{Network Control, Measurement, and Bias}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Room B}{Adaptive Social Networks and Belief Dynamics}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{2:45}{Information-mediated homophily in adaptive networks}{Joshua 
		Rosen}{Northeastern University}{}
		\Talk{3:05}{Bridging Simple and Complex Contagions in Belief Dynamics: A 
		Voter Model Extension}{Jo{\~a}o Franco}{Vermont Complex Systems Center, 
		University of Vermont}{}
		\Talk{3:25}{Identifying brain network features that drive opinion formation 
		and changes in humans}{Brian L. Clary}{Penn State University}{}
	\end{itemize}
	...
	\Session{Room A}{Information, Entropy, and Behavioral Signals}{}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Room B}{Media, Platforms, and Field Mapping}{}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{}{Title TBA}{Filippo Radicchi}{Indiana University}{}
	\end{itemize}
	
		\BreakItem{Break}{10:15 - 10:30}
	\TimeBlock{Parallel Sessions 3}{10:30 - 11:30}{}
	
	\Session{Room A}{Social / Institutional Simulation and Innovation Dynamics}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Room B}{Infrastructure, Risk, and Public/Health Networks}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		Diagnostics}{Hayford Adjavor}{Binghamton University, SUNY}{}
	...
	\Session{Room A}{Graph Methods and Applied Dynamics}{}
	\begin{itemize}[label={}, leftmargin=0pt]
		\Talk{1:30}{distanceclosure: A Python Package for Network Sparsification 
		Based on Their Topology}{Robert Palermo}{Binghamton University, SUNY}{}
	...
	\Session{Room B}{Computational Models and Algorithm Diagnostics}{}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Room A}{Self-Organization, Robustness, and Epidemic Coupling}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Room B}{Collapse, Inequality, and Sustainability Dynamics}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Room A}{LLM Learning, Optimization, and Alignment}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
	...
	\Session{Room B}{LLM Agents in Social Systems (80 min session)}{TBD}
	\begin{itemize}[label={}, leftmargin=0pt]
		...
		\Talk{11:30}{Why We Experience Society Differently: Intrinsic Dispositions as 
		Drivers of Ideological Complexity in Adaptive Social Networks}{Akshay Gangadhar}{Binghamton University}{}
	\end{itemize}
	
	
		\TimeBlock{NERCCS Business Meeting}{11:50 - 12:30}{}
