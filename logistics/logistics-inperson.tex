...
\textbf{[PLACEHOLDER: Lot name/number and address]}\\
\textit{Cost: [PLACEHOLDER: rate, e.g., free / \$X per day / metered]}\\
Distance from Goergen Hall: [PLACEHOLDER: e.g., 5-minute walk]

\subsection{Additional Parking Options}
\begin{itemize}
    \item \textbf{[PLACEHOLDER: Lot/Garage name]} --- [PLACEHOLDER: address, rate, notes]
    \item \textbf{[PLACEHOLDER: Lot/Garage name]} --- [PLACEHOLDER: address, rate, notes]
\end{itemize}

\subsection{Parking Permit / Validation}
[PLACEHOLDER: Instructions for obtaining a daily permit or getting validation, if applicable.
E.g., ``Pick up a visitor parking permit at the registration desk upon arrival.'']

\subsection{Accessible Parking}
[PLACEHOLDER: Location of accessible/ADA spaces near Goergen Hall.]
